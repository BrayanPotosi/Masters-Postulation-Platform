# Generated by Django 3.2.4 on 2021-06-30 16:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='profiles.gender')),
                ('job_status', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='profiles.jobstatus')),
                ('process_status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='profiles.processstatus')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='profiles.countries')),
            ],
        ),
        migrations.AddField(
            model_name='address',
